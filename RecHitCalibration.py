...
class RecHitCalibration:
    ...
    def __init__(self):
        ...
        # https://github.com/cms-sw/cmssw/blob/CMSSW_9_0_X/RecoLocalCalo/HGCalRecProducers/python/HGCalRecHit_cfi.py#L82
        self.thicknessCorrection = (0.964, 0.920, 0.909)  # 100, 200, 300 um

        # Base configurations for HGCal digitizers
        # https://github.com/cms-sw/cmssw/blob/CMSSW_9_0_X/SimCalorimetry/HGCalSimProducers/python/hgcalDigitizer_cfi.py#L5-L6
        # self.eV_per_eh_pair = 3.62
        self.fC_per_ele = 1.6020506e-4
        self.nonAgedNoises = (2100.0, 2100.0, 1600.0)  # 100,200,300 um (in electrons)

        # https://github.com/cms-sw/cmssw/blob/CMSSW_9_0_X/RecoLocalCalo/HGCalRecProducers/python/HGCalUncalibRecHit_cfi.py#L25
